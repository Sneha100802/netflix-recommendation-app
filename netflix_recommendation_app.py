...
# Streamlit file uploader with a unique key
uploaded_file = st.file_uploader("Upload netflix_titles CSV", type=["csv"], key="file_uploader")
...
if uploaded_file is not None:
    ...
    # Input widgets
    query = st.text_input("Enter a genre, actor, or keyword...", placeholder="e.g., comedy, Tom Hanks", key="query_input")
    content_type = st.selectbox("Type", ['All', 'Movie', 'TV Show'], key="content_type")
    top_n = st.slider("Number of Recommendations", 1, 20, 5, key="top_n_slider")
